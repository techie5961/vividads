...
@section('main')
    <section class="w--full column g-10">
        <form style="border:1px solid var(--rgt-005)" onsubmit="PostRequest(event,this,MyFunc.Completed)" action="{{ url('users/post/redeem/gift/code/process') }}" method="POST" class="w-full bg-light br-primary p-20 column g-10">
